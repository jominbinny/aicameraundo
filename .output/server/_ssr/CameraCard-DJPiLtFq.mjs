...
import { c as MapPin, N as Navigation } from "../_libs/lucide-react.mjs";
...
function CameraCard(props) {
  ...
  const { t } = useLanguage();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "flex items-start gap-3 rounded-2xl border border-border bg-card p-4 shadow-sm transition-shadow hover:shadow-md", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-0.5 flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-accent text-primary", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-5 w-5", "aria-hidden": "true" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "truncate font-semibold text-foreground", children: camera.name || "AI Camera" }),
      ...
      camera.distanceKm != null && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-1 inline-flex items-center gap-1 text-sm font-medium text-primary", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Navigation, { className: "h-3.5 w-3.5", "aria-hidden": "true" }),
        formatDistance(camera.distanceKm)
      ] })
    ] }),
    (onShowOnMap || action) && (action || /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
