...
import { H as House, M as Map, L as LocateFixed, R as Route$7, C as Calculator } from "../_libs/lucide-react.mjs";
...
function BottomNav() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "nav",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mx-auto flex max-w-xl items-stretch justify-around", children: items.map(({ to, icon: Icon, label }) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Link,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "h-5 w-5", "aria-hidden": "true" }),
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(LanguageProvider, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen pb-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }),
...
const $$splitComponentImporter$4 = () => import("./route-checker-C43m7UC6.mjs");
...
const $$splitComponentImporter$3 = () => import("./near-me-D3WAAl0u.mjs");
...
const $$splitComponentImporter$2 = () => import("./map-DMcZ1qOh.mjs");
...
const $$splitComponentImporter$1 = () => import("./fine-calculator-CLRJLAmI.mjs");
...
const $$splitComponentImporter = () => import("./index-CGXIrXVe.mjs");
