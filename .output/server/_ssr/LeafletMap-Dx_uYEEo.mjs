...
import "../_libs/leaflet.markercluster.mjs";
import { M as MapContainer, T as TileLayer, P as Polyline, a as Marker, b as Popup, u as useMap } from "../_libs/react-leaflet.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    MapContainer,
    {
      ...
      children: [
        ...
        routeLine && routeLine.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
          Polyline,
          {
        ...
        userPosition && /* @__PURE__ */ jsxRuntimeExports.jsx(Marker, { position: [userPosition.lat, userPosition.lng], icon: userIcon, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Popup, { children: "You are here" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(MapController, { center, zoom, fitBounds })
      ]
    }
  );
}
